...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void updateMap(Location location) {
        ...
        List<LatLng> parkLocations = new ArrayList<LatLng>();
        parkLocations.add(new LatLng(p1.getLat(), p1.getLon()));
        parkLocations.add(new LatLng(p2.getLat(), p2.getLon()));
        parkLocations.add(new LatLng(p3.getLat(), p3.getLon()));
        LatLng userLocation = new LatLng(location.getLatitude(), location.getLongitude());
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(userLocation, 15));
        mMap.addMarker(new MarkerOptions().position(userLocation).title("You are here"));
        for (LatLng latLng: parkLocations)
